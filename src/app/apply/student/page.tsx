        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input id="phone" name="phone" type="tel" required pattern="^\+?[0-9\s\-\(\)]{7,20}$" title="Please enter a valid phone number, e.g., +1 234 567 890" placeholder="+1 234 567 890" className="glass-input block w-full rounded-xl px-4 py-2.5 text-sm" />
            </div>
            <div>
