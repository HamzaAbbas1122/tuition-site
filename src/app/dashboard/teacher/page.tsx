                  ...
                  {t.sessions.map(s => (
                    <div key={s.id} className="border border-slate-200/80 bg-slate-50/70 p-4.5 rounded-xl flex flex-col justify-between gap-3 relative shadow-xs">
                      ...
                      {s.rescheduleStatus === 'PENDING' ? (
                        ...
                        <div className="mt-1 text-right border-t border-slate-200/60 pt-2.5">
                          <p className="text-xs font-bold mb-1.5 text-slate-500">Request Reschedule (Same Day)</p>
                          <form action={requestReschedule.bind(null, s.id)} className="flex flex-col gap-2 items-end">
                            ...
                            <button className="bg-amber-100 border border-amber-200 text-amber-800 hover:bg-amber-200 px-3 py-1 rounded-lg text-xs font-semibold transition-all">Submit</button>
                          </form>
                        </div>
                      )}
